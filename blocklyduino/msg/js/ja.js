...
Blockly.Msg.CATEGORY_INTERRUPTS = "割り込み処理";
...
Blockly.Msg.CONTROLS_RETURN_TOOLTIP = "関数の実行を中止して、呼び出し元の関数に処理を戻します。 ";
Blockly.Msg.CONTROLS_WHILEUNTIL_HELPURL = "https://github.com/google/blockly/wiki/Loops#repeat";  // untranslated
Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_UNTIL = "まで、";
Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_WHILE = "の間、";
...
Blockly.Msg.CONTROLS_WHILE_TOOLTIP = "カッコ内の式がfalseになるまで、処理は無限に繰り返されます。";
Blockly.Msg.COPY_BUTTON = "コードをクリップコピー";
Blockly.Msg.COPY_DONE = "コピー完了！";
Blockly.Msg.DATA_LENGTH = "データ長";
...
Blockly.Msg.DIALOG_EXPORT_OK = "閉じる";
...
Blockly.Msg.GROVE_IR_EMITTER_SEND_TITLE = "データ送信";
Blockly.Msg.GROVE_IR_EMITTER_SEND_TOOLTIP = "データを送信する。";
Blockly.Msg.GROVE_IR_EMITTER_TITLE = "赤外線発信";
...
Blockly.Msg.GROVE_IR_RECEIVER_CHECK_DATA_TOOLTIP = "データの有無を確認する";
Blockly.Msg.GROVE_IR_RECEIVER_DATA_TITLE = "受信したデータ";
Blockly.Msg.GROVE_IR_RECEIVER_DATA_TOOLTIP = "受信したデータ";
Blockly.Msg.GROVE_IR_RECEIVER_HELPURL = "http://www.seeedstudio.com/wiki/Grove_-_Infrared_Receiver";
Blockly.Msg.GROVE_IR_RECEIVER_INIT_TITLE = "初期化";
Blockly.Msg.GROVE_IR_RECEIVER_INIT_TOOLTIP = "使用するピンを設定する。";
Blockly.Msg.GROVE_IR_RECEIVER_INIT_WARNING = "(Grove) IRSendRev ライブラリをインストールしてください。";
Blockly.Msg.GROVE_IR_RECEIVER_RECEIVE_TITLE = "データ受信";
Blockly.Msg.GROVE_IR_RECEIVER_RECEIVE_TOOLTIP = "データを受け取る。";
Blockly.Msg.GROVE_IR_RECEIVER_TITLE = "赤外線受信";
Blockly.Msg.GROVE_IR_RECEIVER_WARNING = "初期化ブロックが必要です。";
...
Blockly.Msg.GROVE_RGB_LCD_WARNING = "初期化ブロックが必要です。";
...
Blockly.Msg.I2C_MATRIX_BEGIN_TITLE = "初期化";
...
Blockly.Msg.I2C_MATRIX_WARNING = "初期化ブロックが必要です。";
...
Blockly.Msg.I2C_SEVENSEG_BEGIN_TITLE = "初期化";
...
Blockly.Msg.I2C_SEVENSEG_WARNING = "初期化ブロックが必要です。";
...
Blockly.Msg.INTERRUPTS_ATTACH_HELPURL = "http://www.musashinodenpa.com/arduino/ref/index.php?f=0&pos=3045";
Blockly.Msg.INTERRUPTS_ATTACH_TITLE = "外部割り込みの設定";
Blockly.Msg.INTERRUPTS_ATTACH_TOOLTIP = "外部割り込みが発生したときに実行する関数を指定します。";
Blockly.Msg.INTERRUPTS_DETACH_HELPURL = "http://www.musashinodenpa.com/arduino/ref/index.php?f=0&pos=3103";
Blockly.Msg.INTERRUPTS_DETACH_TITLE = "外部割り込みの停止";
Blockly.Msg.INTERRUPTS_DETACH_TOOLTIP = "指定した割り込みを停止します。 ";
...
Blockly.Msg.INTERRUPTS_NO_TITLE = "割り込みの無効化";
Blockly.Msg.INTERRUPTS_NO_TOOLTIP = "割り込みを無効にします。interrupts関数でまた有効にできます。 ";
Blockly.Msg.INTERRUPTS_TITLE = "割り込みの有効化";
Blockly.Msg.INTERRUPTS_TOOLTIP = "noInterrupts関数によって停止した割り込みを有効にします。 ";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MODULO = "2 つの数の剰余を返します。";
...
Blockly.Msg.MODE = "モード";
Blockly.Msg.MPR121_BEGIN_TITLE = "初期化";
Blockly.Msg.MPR121_BEGIN_TOOLTIP = "センサーを初期化します";
...
Blockly.Msg.MPR121_POSITION = "場所";
Blockly.Msg.MPR121_RELEASED_TITLE = "から手を離した？";
Blockly.Msg.MPR121_RELEASED_TOOLTIP = "センサーから手が離れたら、Trueを返す";
Blockly.Msg.MPR121_RESET_TITLE = "リセット";
Blockly.Msg.MPR121_RESET_TOOLTIP = "センサーの値をリセットします";
Blockly.Msg.MPR121_TOUCHED_TITLE = "に触った？";
Blockly.Msg.MPR121_TOUCHED_TOOLTIP = "センサーに触ったら、Trueを返す";
Blockly.Msg.MPR121_VALUE_TITLE = "静電容量の値";
Blockly.Msg.MPR121_VALUE_TOOLTIP = "静電容量の値";
Blockly.Msg.MPR121_WARNING = "初期化ブロックが必要です。";
Blockly.Msg.NEOPIXEL_BEGIN_BRIGHTNESS = "明るさ";
Blockly.Msg.NEOPIXEL_BEGIN_HELPURL = "https://github.com/adafruit/Adafruit_NeoPixel";
Blockly.Msg.NEOPIXEL_BEGIN_NUM = "LEDの数";
Blockly.Msg.NEOPIXEL_BEGIN_PIN = "ピン";
Blockly.Msg.NEOPIXEL_BEGIN_SETTING = "初期化";
Blockly.Msg.NEOPIXEL_BEGIN_TOOLTIP = "NeoPixelライブラリを初期化します。";
...
Blockly.Msg.NEOPIXEL_CUSTOM_SETPIXELCOLOR_TOOLTIP = "色をRBGの値（0,0,0〜255,255,255）で設定します。";
...
Blockly.Msg.NEOPIXEL_SETPIXELCOLOR_TOOLTIP = "色を設定します。";
Blockly.Msg.NEOPIXEL_SHOW = "表示";
Blockly.Msg.NEOPIXEL_SHOW_HELPURL = "https://github.com/adafruit/Adafruit_NeoPixel";
Blockly.Msg.NEOPIXEL_SHOW_TOOLTIP = "色の設定をLEDに送ります。";
Blockly.Msg.NEOPIXEL_WARNING = "初期化ブロックが必要です。";
...
Blockly.Msg.RGBLED_BEGIN_NUM = "LEDの数";
...
Blockly.Msg.SHIELD_BOT_BACKWARD = "後進";
Blockly.Msg.SHIELD_BOT_CONTROL = "";
Blockly.Msg.SHIELD_BOT_DRIVE_TITLE = "モーター制御";
Blockly.Msg.SHIELD_BOT_DRIVE_TOOLTIP = "左右のモーターを直接制御する。";
Blockly.Msg.SHIELD_BOT_FASTSTOP_LEFTTOOLTIP = "左モーターを急停止させる。あまり使わない方が良い。";
Blockly.Msg.SHIELD_BOT_FASTSTOP_LEFT_TITLE = "急停止(左モーター)";
Blockly.Msg.SHIELD_BOT_FASTSTOP_RIGHT_TITLE = "急停止(右モーター)";
Blockly.Msg.SHIELD_BOT_FASTSTOP_RIGHT_TOOLTIP = "右モーターを急停止させる。あまり使わない方がよい。";
Blockly.Msg.SHIELD_BOT_FASTSTOP_TITLE = "急停止";
Blockly.Msg.SHIELD_BOT_FASTSTOP_TOOLTIP = "急に停止する。あまり使わない方が良い。";
Blockly.Msg.SHIELD_BOT_FORWARD = "前進";
Blockly.Msg.SHIELD_BOT_HELPURL = "http://www.seeedstudio.com/wiki/Shield_Bot_V1.2";
Blockly.Msg.SHIELD_BOT_LEFT_SPEED = "左";
Blockly.Msg.SHIELD_BOT_MOTOR = "のモーターを動かす";
Blockly.Msg.SHIELD_BOT_MOTOR_TOOLTIP = "左右のモーターを動かす。前進はプラス、後進はマイナス。";
Blockly.Msg.SHIELD_BOT_MOVE_TITLE = "Botを動かす";
Blockly.Msg.SHIELD_BOT_MOVE_TOOLTIP = "Sheildbotを指定した動作で動かす。";
Blockly.Msg.SHIELD_BOT_READ_SENSOR_TITLE = "センサーの値";
Blockly.Msg.SHIELD_BOT_READ_SENSOR_TOOLTIP = "指定した場所のセンサーの値を確認する。";
Blockly.Msg.SHIELD_BOT_RIGHT_SPEED = "右";
Blockly.Msg.SHIELD_BOT_SETMAXSPEED_LR_TOOLTIP = "右と左それぞれのモーターのスピードを設定する。値は、0(ストップ) 〜 255(フルスピード)";
Blockly.Msg.SHIELD_BOT_SETMAXSPEED_TITLE = "モータースピード";
Blockly.Msg.SHIELD_BOT_SETMAXSPEED_TOOLTIP = "両方のモーターのスピードを設定する。値は、0(ストップ) 〜 255(フルスピード)";
Blockly.Msg.SHIELD_BOT_STOP = "停止";
Blockly.Msg.SHIELD_BOT_STOPLEFT = "左モーターの停止";
Blockly.Msg.SHIELD_BOT_STOPRIGHT = "右モーターの停止";
Blockly.Msg.STRING = "文字";
Blockly.Msg.TERM = "ターミナル";
Blockly.Msg.TEXT = "テキスト";
Blockly.Msg.TEXTAREA_EXPORT_LABEL = "コードをコピーしてください";
Blockly.Msg.TEXTAREA_IMPORT_LABEL = "コードを貼り付けてください";
...
Blockly.Msg.VARIABLES_TYPE_CHAR = "1文字";
Blockly.Msg.VARIABLES_TYPE_COLOUR = "色";
Blockly.Msg.VARIABLES_TYPE_DOUBLE = "倍数精度浮動小数点";
Blockly.Msg.VARIABLES_TYPE_FLOAT = "浮動小数点";
Blockly.Msg.VARIABLES_TYPE_LONG = "ロング";
Blockly.Msg.VARIABLES_TYPE_NUMBER = "整数";
Blockly.Msg.VARIABLES_TYPE_STRING = "テキスト";
Blockly.Msg.VARIABLES_TYPE_UNSIGNED_INT = "符号なし整数";
Blockly.Msg.VARIABLES_TYPE_UNSIGNED_LONG = "符号なしロング";
